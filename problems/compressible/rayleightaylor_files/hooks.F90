module rayleightaylor_data
    ...
    real(rkind) :: p_pre = real(1.0D5, rkind) ! Ambient pressure in Pa
...
subroutine initfields(decomp,dx,dy,dz,inputfile,mesh,fields,mix,tsim,tstop,dt,tviz)
    ...
    real(rkind) :: rho_ref = 1.0_rkind, T_ref = 1.0_rkind, viscous_exponent = 0.75_rkind, Pr1, amp
