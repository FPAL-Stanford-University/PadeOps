module ChannelGrowth_parameters
...
subroutine meshgen_wallM(decomp, dx, dy, dz, mesh, inputfile)
    use ChannelGrowth_parameters    
    use kind_parameters,  only: rkind, clen
    use ChannelGrowth_IO, only: read_domain_info 
    ...
    namelist /ChannelGrowth/ InitFileTag, InitFileDirectory, Noise_Amp, ProblemMode
...
subroutine setDirichletBC_Temp(inputfile, Tsurf, dTsurf_dt)
    ...
    real(rkind) :: Noise_Amp = 1.d-6
    integer :: ProblemMode = 1
    namelist /ChannelGrowth/ Lx, Ly, Lz, alphaRot, Noise_Amp, ProblemMode
