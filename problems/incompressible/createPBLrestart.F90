program createPBLrestart 
   ...
   namelist /INPUT/ nx, ny, nz, Lx, Ly, Lz, tid, RID,  outputdir, matlabfile
   ...
   fname1 = OutputDir(:len_trim(OutputDir))//"/"//trim(tempname)
   call spectC%init("x", nx, ny, nz, dx, dy, dz, "FOUR", "2/3rd", 2, .false., .false., .true., .true., .false., .true.)
