module ManufacturedSolutionPlastic_data
    use kind_parameters,  only: rkind
    use constants,        only: one,eight
    implicit none

    real(rkind) :: sigma_0 = one
    real(rkind) :: gamma, p_infty, rho_0, sigma_Y, tau_0
    real(rkind) :: muL, lamL, cL

contains

! Heaviside function for the rest of the source terms
REAL*8 function Heaviside(x)
use constants, only: half, one, eps
REAL*8, intent(in) :: x

Heaviside = half*(one + erf(x/eps))
...
REAL*8 function g11_source(gamma, mu, p_infty, rho_0, sigma_0, sigma_Y, t, &
      tau_0, x)
implicit none
...
REAL*8, intent(in) :: sigma_Y
REAL*8, intent(in) :: t
REAL*8, intent(in) :: tau_0
REAL*8, intent(in) :: x

g11_source = sigma_0**2*sqrt((gamma*p_infty + (4.0d0/3.0d0)*mu)/rho_0)*( &
      ...
      *p_infty + 1.33333333333333d0*mu)/rho_0) + 10.0d0*x - 5.0d0)**2)/ &
      (gamma*p_infty + (4.0d0/3.0d0)*mu) + 1)**2) + tau_0*((1.0d0/3.0d0 &
      )*(-2 + 2/(-sigma_0*exp(-(-10.0d0*t*sqrt((gamma*p_infty + &
      1.33333333333333d0*mu)/rho_0) + 10.0d0*x - 5.0d0)**2)/(gamma* &
      p_infty + (4.0d0/3.0d0)*mu) + 1)**4)/((-sigma_0*exp(-(-10.0d0*t* &
      sqrt((gamma*p_infty + 1.33333333333333d0*mu)/rho_0) + 10.0d0*x - &
      5.0d0)**2)/(gamma*p_infty + (4.0d0/3.0d0)*mu) + 1)**(-2))**(2.0d0 &
      /3.0d0) - 1.0d0/3.0d0*(-2 + 2/(-sigma_0*exp(-(-10.0d0*t*sqrt(( &
      gamma*p_infty + 1.33333333333333d0*mu)/rho_0) + 10.0d0*x - 5.0d0) &
      **2)/(gamma*p_infty + (4.0d0/3.0d0)*mu) + 1)**2)/((-sigma_0*exp(- &
      (-10.0d0*t*sqrt((gamma*p_infty + 1.33333333333333d0*mu)/rho_0) + &
      10.0d0*x - 5.0d0)**2)/(gamma*p_infty + (4.0d0/3.0d0)*mu) + 1)**( &
      -2))**(1.0d0/3.0d0))*Heaviside(mu**2*(0.333333333333333*(-2.0 + &
      2.0/(-sigma_0*exp(-(-10.0*t*sqrt((gamma*p_infty + 4*mu/3)/rho_0) &
      + 10.0*x - 5.0)**2)/(gamma*p_infty + 1.33333333333333*mu) + 1.0) &
      **4)*((-sigma_0*exp(-(-10.0*t*sqrt((gamma*p_infty + 4*mu/3)/rho_0 &
      ) + 10.0*x - 5.0)**2)/(gamma*p_infty + 1.33333333333333*mu) + 1.0 &
      )**(-2))**(-0.666666666666667) - 0.333333333333333*(-2.0 + 2.0/( &
      -sigma_0*exp(-(-10.0*t*sqrt((gamma*p_infty + 4*mu/3)/rho_0) + &
      10.0*x - 5.0)**2)/(gamma*p_infty + 1.33333333333333*mu) + 1.0)**2 &
      )*((-sigma_0*exp(-(-10.0*t*sqrt((gamma*p_infty + 4*mu/3)/rho_0) + &
      10.0*x - 5.0)**2)/(gamma*p_infty + 1.33333333333333*mu) + 1.0)**( &
      -2))**(-0.333333333333333))**2/(-sigma_0*exp(-(-10.0*t*sqrt(( &
      gamma*p_infty + 4*mu/3)/rho_0) + 10.0*x - 5.0)**2)/(gamma*p_infty &
      + 1.33333333333333*mu) + 1.0)**2 + 2.0*mu**2*(0.333333333333333*( &
      1.0 - 1/(-sigma_0*exp(-(-10.0*t*sqrt((gamma*p_infty + 4*mu/3)/ &
      rho_0) + 10.0*x - 5.0)**2)/(gamma*p_infty + 1.33333333333333*mu) &
      + 1.0)**4)*((-sigma_0*exp(-(-10.0*t*sqrt((gamma*p_infty + 4*mu/3) &
      /rho_0) + 10.0*x - 5.0)**2)/(gamma*p_infty + 1.33333333333333*mu &
      ) + 1.0)**(-2))**(-0.666666666666667) - 0.333333333333333*(1.0 - &
      1/(-sigma_0*exp(-(-10.0*t*sqrt((gamma*p_infty + 4*mu/3)/rho_0) + &
      10.0*x - 5.0)**2)/(gamma*p_infty + 1.33333333333333*mu) + 1.0)**2 &
      )*((-sigma_0*exp(-(-10.0*t*sqrt((gamma*p_infty + 4*mu/3)/rho_0) + &
      10.0*x - 5.0)**2)/(gamma*p_infty + 1.33333333333333*mu) + 1.0)**( &
      -2))**(-0.333333333333333))**2/(-sigma_0*exp(-(-10.0*t*sqrt(( &
      gamma*p_infty + 4*mu/3)/rho_0) + 10.0*x - 5.0)**2)/(gamma*p_infty &
      + 1.33333333333333*mu) + 1.0)**2 - 0.666666666666667*sigma_Y**2)/ &
      (mu*(-sigma_0*exp(-(-10.0d0*t*sqrt((gamma*p_infty + &
      1.33333333333333d0*mu)/rho_0) + 10.0d0*x - 5.0d0)**2)/(gamma* &
      p_infty + (4.0d0/3.0d0)*mu) + 1)**2)
...
REAL*8 function g22_source(gamma, mu, p_infty, rho_0, sigma_0, sigma_Y, t, &
      tau_0, x)
implicit none
REAL*8, intent(in) :: gamma
REAL*8, intent(in) :: mu
...
g22_source = tau_0*((1.0d0/3.0d0)*(1 - 1/(-sigma_0*exp(-(-10.0d0*t*sqrt &
      ((gamma*p_infty + 1.33333333333333d0*mu)/rho_0) + 10.0d0*x - &
      5.0d0)**2)/(gamma*p_infty + (4.0d0/3.0d0)*mu) + 1)**4)/((-sigma_0 &
      *exp(-(-10.0d0*t*sqrt((gamma*p_infty + 1.33333333333333d0*mu)/ &
      rho_0) + 10.0d0*x - 5.0d0)**2)/(gamma*p_infty + (4.0d0/3.0d0)*mu &
      ) + 1)**(-2))**(2.0d0/3.0d0) - 1.0d0/3.0d0*(1 - 1/(-sigma_0*exp(- &
      (-10.0d0*t*sqrt((gamma*p_infty + 1.33333333333333d0*mu)/rho_0) + &
      10.0d0*x - 5.0d0)**2)/(gamma*p_infty + (4.0d0/3.0d0)*mu) + 1)**2) &
      /((-sigma_0*exp(-(-10.0d0*t*sqrt((gamma*p_infty + &
      1.33333333333333d0*mu)/rho_0) + 10.0d0*x - 5.0d0)**2)/(gamma* &
      p_infty + (4.0d0/3.0d0)*mu) + 1)**(-2))**(1.0d0/3.0d0))*Heaviside &
      (mu**2*(0.333333333333333*(-2.0 + 2.0/(-sigma_0*exp(-(-10.0*t* &
      sqrt((gamma*p_infty + 4*mu/3)/rho_0) + 10.0*x - 5.0)**2)/(gamma* &
      p_infty + 1.33333333333333*mu) + 1.0)**4)*((-sigma_0*exp(-(-10.0* &
      t*sqrt((gamma*p_infty + 4*mu/3)/rho_0) + 10.0*x - 5.0)**2)/(gamma &
      *p_infty + 1.33333333333333*mu) + 1.0)**(-2))**( &
      -0.666666666666667) - 0.333333333333333*(-2.0 + 2.0/(-sigma_0*exp &
      (-(-10.0*t*sqrt((gamma*p_infty + 4*mu/3)/rho_0) + 10.0*x - 5.0)** &
      2)/(gamma*p_infty + 1.33333333333333*mu) + 1.0)**2)*((-sigma_0* &
      exp(-(-10.0*t*sqrt((gamma*p_infty + 4*mu/3)/rho_0) + 10.0*x - 5.0 &
      )**2)/(gamma*p_infty + 1.33333333333333*mu) + 1.0)**(-2))**( &
      -0.333333333333333))**2/(-sigma_0*exp(-(-10.0*t*sqrt((gamma* &
      p_infty + 4*mu/3)/rho_0) + 10.0*x - 5.0)**2)/(gamma*p_infty + &
      1.33333333333333*mu) + 1.0)**2 + 2.0*mu**2*(0.333333333333333*( &
      1.0 - 1/(-sigma_0*exp(-(-10.0*t*sqrt((gamma*p_infty + 4*mu/3)/ &
      rho_0) + 10.0*x - 5.0)**2)/(gamma*p_infty + 1.33333333333333*mu) &
      + 1.0)**4)*((-sigma_0*exp(-(-10.0*t*sqrt((gamma*p_infty + 4*mu/3) &
...
REAL*8 function g33_source(gamma, mu, p_infty, rho_0, sigma_0, sigma_Y, t, &
      tau_0, x)
implicit none
REAL*8, intent(in) :: gamma
REAL*8, intent(in) :: mu
...
g33_source = tau_0*((1.0d0/3.0d0)*(1 - 1/(-sigma_0*exp(-(-10.0d0*t*sqrt &
      ((gamma*p_infty + 1.33333333333333d0*mu)/rho_0) + 10.0d0*x - &
      5.0d0)**2)/(gamma*p_infty + (4.0d0/3.0d0)*mu) + 1)**4)/((-sigma_0 &
      *exp(-(-10.0d0*t*sqrt((gamma*p_infty + 1.33333333333333d0*mu)/ &
      rho_0) + 10.0d0*x - 5.0d0)**2)/(gamma*p_infty + (4.0d0/3.0d0)*mu &
...
REAL*8 function mass_source(gamma, mu, p_infty, rho_0, sigma_0, t, x)
implicit none
REAL*8, intent(in) :: gamma
REAL*8, intent(in) :: mu
REAL*8, intent(in) :: p_infty
...
mass_source = rho_0*sigma_0**2*sqrt((gamma*p_infty + (4.0d0/3.0d0)*mu)/ &
      ...
      **2)/(gamma*p_infty + (4.0d0/3.0d0)*mu) + 1)**2) + rho_0*sigma_0* &
      ...
      1.33333333333333d0*mu)/rho_0) + 10.0d0*x - 5.0d0)**2)/(gamma* &
      p_infty + (4.0d0/3.0d0)*mu) + 1)) + 20.0d0*rho_0*sigma_0*sqrt(( &
...
momentum_source = gamma*p_infty*sigma_0*(200.0d0*t*sqrt((gamma*p_infty + &
      ...
      p_infty + (4.0d0/3.0d0)*mu)*(-sigma_0*exp(-(-10.0d0*t*sqrt((gamma &
      *p_infty + 1.33333333333333d0*mu)/rho_0) + 10.0d0*x - 5.0d0)**2)/ &
      (gamma*p_infty + (4.0d0/3.0d0)*mu) + 1)) + mu*sigma_0*((1.0d0/ &
      3.0d0)*(-2 + 2/(-sigma_0*exp(-(-10.0d0*t*sqrt((gamma*p_infty + &
      1.33333333333333d0*mu)/rho_0) + 10.0d0*x - 5.0d0)**2)/(gamma* &
      p_infty + (4.0d0/3.0d0)*mu) + 1)**4)/((-sigma_0*exp(-(-10.0d0*t* &
      sqrt((gamma*p_infty + 1.33333333333333d0*mu)/rho_0) + 10.0d0*x - &
      5.0d0)**2)/(gamma*p_infty + (4.0d0/3.0d0)*mu) + 1)**(-2))**(2.0d0 &
      ...
      **2)/(gamma*p_infty + (4.0d0/3.0d0)*mu) + 1)**2)/((-sigma_0*exp(- &
      (-10.0d0*t*sqrt((gamma*p_infty + 1.33333333333333d0*mu)/rho_0) + &
      10.0d0*x - 5.0d0)**2)/(gamma*p_infty + (4.0d0/3.0d0)*mu) + 1)**( &
      -2))**(1.0d0/3.0d0))*(200.0d0*t*sqrt((gamma*p_infty + (4.0d0/ &
      ...
      **2)/((gamma*p_infty + (4.0d0/3.0d0)*mu)*(-sigma_0*exp(-(-10.0d0* &
      ...
      - 5.0d0)**2)/(gamma*p_infty + (4.0d0/3.0d0)*mu) + 1)**2) + mu*( &
      -4.0d0/9.0d0*sigma_0*(-2 + 2/(-sigma_0*exp(-(-10.0d0*t*sqrt(( &
      gamma*p_infty + 1.33333333333333d0*mu)/rho_0) + 10.0d0*x - 5.0d0) &
      **2)/(gamma*p_infty + (4.0d0/3.0d0)*mu) + 1)**4)*(200.0d0*t*sqrt &
      ((gamma*p_infty + (4.0d0/3.0d0)*mu)/rho_0) - 200.0d0*x + 100.0d0) &
      *exp(-(-10.0d0*t*sqrt((gamma*p_infty + 1.33333333333333d0*mu)/ &
      rho_0) + 10.0d0*x - 5.0d0)**2)/((gamma*p_infty + (4.0d0/3.0d0)*mu &
      )*(-sigma_0*exp(-(-10.0d0*t*sqrt((gamma*p_infty + &
      ...
      ((gamma*p_infty + 1.33333333333333d0*mu)/rho_0) + 10.0d0*x - &
      5.0d0)**2)/(gamma*p_infty + (4.0d0/3.0d0)*mu) + 1)**(-2))**(2.0d0 &
      /3.0d0)) + (2.0d0/9.0d0)*sigma_0*(-2 + 2/(-sigma_0*exp(-(-10.0d0* &
      t*sqrt((gamma*p_infty + 1.33333333333333d0*mu)/rho_0) + 10.0d0*x &
      - 5.0d0)**2)/(gamma*p_infty + (4.0d0/3.0d0)*mu) + 1)**2)*(200.0d0 &
...
energy_source = rho_0*sigma_0**2*sqrt((gamma*p_infty + (4.0d0/3.0d0)*mu) &
      ...
      *x - 5.0d0)*exp(-(-10.0d0*t*sqrt((gamma*p_infty + &
      ...
      1.0d0/3.0d0)*(-2 + 2/(-sigma_0*exp(-(-10.0d0*t*sqrt((gamma* &
      p_infty + 1.33333333333333d0*mu)/rho_0) + 10.0d0*x - 5.0d0)**2)/( &
      gamma*p_infty + (4.0d0/3.0d0)*mu) + 1)**4)/((-sigma_0*exp(-( &
      -10.0d0*t*sqrt((gamma*p_infty + 1.33333333333333d0*mu)/rho_0) + &
      10.0d0*x - 5.0d0)**2)/(gamma*p_infty + (4.0d0/3.0d0)*mu) + 1)**( &
      -2))**(2.0d0/3.0d0) - 1.0d0/3.0d0*(-2 + 2/(-sigma_0*exp(-(-10.0d0 &
      *t*sqrt((gamma*p_infty + 1.33333333333333d0*mu)/rho_0) + 10.0d0*x &
      - 5.0d0)**2)/(gamma*p_infty + (4.0d0/3.0d0)*mu) + 1)**2)/(( &
      -sigma_0*exp(-(-10.0d0*t*sqrt((gamma*p_infty + 1.33333333333333d0 &
      *mu)/rho_0) + 10.0d0*x - 5.0d0)**2)/(gamma*p_infty + (4.0d0/3.0d0 &
      )*mu) + 1)**(-2))**(1.0d0/3.0d0))/(-sigma_0*exp(-(-10.0d0*t*sqrt &
      ((gamma*p_infty + 1.33333333333333d0*mu)/rho_0) + 10.0d0*x - &
      5.0d0)**2)/(gamma*p_infty + (4.0d0/3.0d0)*mu) + 1) - p_infty*(( &
      1.0/(-sigma_0*exp(-(-10.0d0*t*sqrt((gamma*p_infty + &
      1.33333333333333d0*mu)/rho_0) + 10.0d0*x - 5.0d0)**2)/(gamma* &
      p_infty + (4.0d0/3.0d0)*mu) + 1))**gamma - 1))*(200.0d0*t*sqrt(( &
      gamma*p_infty + (4.0d0/3.0d0)*mu)/rho_0) - 200.0d0*x + 100.0d0)* &
      exp(-(-10.0d0*t*sqrt((gamma*p_infty + 1.33333333333333d0*mu)/ &
      rho_0) + 10.0d0*x - 5.0d0)**2)/(gamma*p_infty + (4.0d0/3.0d0)*mu &
      ) - sigma_0*sqrt((gamma*p_infty + (4.0d0/3.0d0)*mu)/rho_0)*( &
      -gamma*p_infty*sigma_0*(200.0d0*t*sqrt((gamma*p_infty + (4.0d0/ &
      3.0d0)*mu)/rho_0) - 200.0d0*x + 100.0d0)*(1.0/(-sigma_0*exp(-( &
      -10.0d0*t*sqrt((gamma*p_infty + 1.33333333333333d0*mu)/rho_0) + &
      10.0d0*x - 5.0d0)**2)/(gamma*p_infty + (4.0d0/3.0d0)*mu) + 1))** &
      gamma*exp(-(-10.0d0*t*sqrt((gamma*p_infty + 1.33333333333333d0*mu &
      )/rho_0) + 10.0d0*x - 5.0d0)**2)/((gamma*p_infty + (4.0d0/3.0d0)* &
      mu)*(-sigma_0*exp(-(-10.0d0*t*sqrt((gamma*p_infty + &
      1.33333333333333d0*mu)/rho_0) + 10.0d0*x - 5.0d0)**2)/(gamma* &
      p_infty + (4.0d0/3.0d0)*mu) + 1)) - mu*sigma_0*((1.0d0/3.0d0)*(-2 &
...
subroutine meshgen(decomp, dx, dy, dz, mesh)
    ...
    use ManufacturedSolutionPlastic_data
...
subroutine hook_output(decomp,dx,dy,dz,outputdir,mesh,fields,tsim,vizcount)
    ...
    associate( rho    => fields(:,:,:, rho_index), u   => fields(:,:,:,  u_index), &
        ...
        write(outputfile,'(2A,I4.4,A)') trim(outputdir),"/ManufacturedSolutionPlastic_"//trim(str)//"_", vizcount, ".dat"
        ...
        do i=1,decomp%ysz(1)
            write(outputunit,'(14ES26.16)') x(i,1,1), rho(i,1,1), u(i,1,1), e(i,1,1), p(i,1,1), &
                                           ...
                                           g11_source(gamma, muL, p_infty, rho_0, sigma_0, sigma_Y, tsim, tau_0, x(i,1,1))
        end do
        close(outputunit)
...
subroutine hook_source(decomp,mesh,fields,tsim,rhs,rhsg)
    ...
    associate( rho    => fields(:,:,:, rho_index), u   => fields(:,:,:,  u_index), &
        ...
        do k = 1,decomp%ysz(3)
            do j = 1,decomp%ysz(2)
                do i = 1,decomp%ysz(1)
                    rhs (i,j,k,1) = rhs (i,j,k,1) + mass_source(gamma, muL, p_infty, rho_0, sigma_0, tsim, x(i,j,k))
                    ...
                    rhsg(i,j,k,1) = rhsg(i,j,k,1) + g11_source(gamma, muL, p_infty, rho_0, sigma_0, sigma_Y, tsim, tau_0, x(i,j,k))
                    rhsg(i,j,k,5) = rhsg(i,j,k,5) + g22_source(gamma, muL, p_infty, rho_0, sigma_0, sigma_Y, tsim, tau_0, x(i,j,k))
                    rhsg(i,j,k,9) = rhsg(i,j,k,9) + g33_source(gamma, muL, p_infty, rho_0, sigma_0, sigma_Y, tsim, tau_0, x(i,j,k))
                end do
            end do
        end do
