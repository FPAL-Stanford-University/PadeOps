module Oscillatory_Droplet_data
    ...
    real(rkind) :: Ly = 4d0, Lx = 4d0, interface_init = 0.75_rkind,Tp = 4d0, shock_init = 0.6_rkind, kwave = 4.0_rkind,  v0 = 1d0, v0_2 = 1d0, tau0 =1d0, R = 0.8
