...
extern "C" float* loadpytorch(double* train_in, double* strain2_in, double* strain2_m_in, double* rot2_in, double* strainrot_m_in, double* rotstrainrot_m_in, double* strain2rot_m_in, double* rotstrain2_m_in, double* rot_in, int* space1, int* space2, int* space3, double* dx_p, double* dy_p, double* dz_p);
extern "C" void free(void* ptr);

float* loadpytorch(double* train_in, double* strain2_in, double* strain2_m_in, double* rot2_in, double* strainrot_m_in, double* rotstrainrot_m_in, double* strain2rot_m_in, double* rotstrain2_m_in, double* rot_in, int* space1, int* space2, int* space3, double* dx_p, double* dy_p, double* dz_p) {
	...
	torch::Tensor train_loadtensor = torch::zeros({ space1a * space2a * space3a, 11 }, options);
	...
	//std::cout << "invar end" << '\n';
	//for (int j = space1a * space2a * space3a * 11-65; j < space1a*space2a*space3a * 11; j++) {
	//	std::cout << train_in[j] << '\n';
	//}
