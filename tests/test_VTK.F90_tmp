program test_VTK
    ...
    do step = 1,4
        ...
        E_IO = VTK_INI_XML_WRITE(fformat='binary', filename='XML_MPI_f'//trim(strz(3,nrank))//'_'//trim(strz(3,step))//'.vts', &
        ...
        if (nrank == 0) then
            ...
            E_IO = PVTK_INI_XML(filename = 'XML_MPI_'//trim(strz(3,step))//'.pvts', mesh_topology = 'PStructuredGrid',&
            ...
            do i=0,nproc-1
                ...
                E_IO = PVTK_GEO_XML(nx1=nx1,nx2=nx2,ny1=ny1,ny2=ny2,nz1=nz1,nz2=nz2,&
                                    source='XML_MPI_f'//trim(strz(3,i))//'_'//trim(strz(3,step))//'.vts')
            enddo
