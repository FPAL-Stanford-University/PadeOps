! Routines specific to 2nd order Explicit Finite Difference Scheme
...
module d02stuff
    ...
    private
    public :: d02, aD02d1, aD02d2
    ! 2nd order first derivative explicit centeral difference coefficients
    real(rkind), parameter :: aD02d1     = 1.0_rkind / 2.0_rkind

    ! 2nd order second derivative explicit centeral difference coefficients
    real(rkind), parameter :: aD02d2     = 1.0_rkind
    ...
    real(rkind), parameter :: b1_aD02d2     = 2.0_rkind
    real(rkind), parameter :: b1_bD02d2     = -5.0_rkind
    real(rkind), parameter :: b1_cD02d2     = 4.0_rkind
    real(rkind), parameter :: b1_dD02d2     = -1.0_rkind
    real(rkind), parameter :: b1_eD02d2     = 0.0_rkind

    ! 2nd point: explicit central 2nd order
    real(rkind), parameter :: b2_aD02d2 = 1.0_rkind

    ! 3rd point: explicit central 2nd order
    real(rkind), parameter :: b3_aD02d2  = 1.0_rkind
...
contains
   ...
   pure subroutine ComputeXD2RHS(this, f, RHS, n2, n3, bc1, bcn)
        ...
        case (.FALSE.)
            ...
            a_np_3 = b3_aD02d2 * this%onebydx2 
       
            a_np_2 = b2_aD02d2 * this%onebydx2

            a_np_1 = b1_aD02d2 * this%onebydx2
            b_np_1 = b1_bD02d2 * this%onebydx2
            c_np_1 = b1_cD02d2 * this%onebydx2
            d_np_1 = b1_dD02d2 * this%onebydx2
            e_np_1 = b1_eD02d2 * this%onebydx2
