! Routines specific to 6th order Explicit Finite Difference Scheme
...
module d06stuff
    ...
    private
    public :: d06, aD06d1, bD06d1, cD06d1, aD06d2, bD06d2, cD06d2
    ...
    ! 6th order second derivative explicit centeral difference coefficients
    real(rkind), parameter :: aD06d2     = 3.0_rkind / 2.0_rkind
    real(rkind), parameter :: bD06d2     = -3.0_rkind / 20.0_rkind
    real(rkind), parameter :: cD06d2     = 1.0_rkind / 90.0_rkind
    ...
    real(rkind), parameter                   :: r_hat           = bD06d1
    real(rkind), parameter                   :: s_hat           = cD06d1
    ...
    real(rkind), parameter                   :: r_ppp           = bD06d1
    real(rkind), parameter                   :: s_ppp           = cD06d1
    ...
    real(rkind), parameter :: b1_aD06d2     = 2.0_rkind
    real(rkind), parameter :: b1_bD06d2     = -5.0_rkind
    real(rkind), parameter :: b1_cD06d2     = 4.0_rkind
    real(rkind), parameter :: b1_dD06d2     = -1.0_rkind
    real(rkind), parameter :: b1_eD06d2     = 0.0_rkind

    ! 2nd point: explicit central 2nd order
    real(rkind), parameter :: b2_aD06d2 = 1.0_rkind

    ! 3rd point: explicit central 4th order
    real(rkind), parameter :: b3_aD06d2  = 4.0_rkind / 3.0_rkind
    real(rkind), parameter :: b3_bD06d2  = -1.0_rkind / 12.0_rkind
...
contains
    ...
    pure subroutine ComputeXD1RHS(this, f, RHS, n2, n3, bc1, bcn)
        ...
        case (.TRUE.)
            ...
            b10 = bD06d1 * this%onebydx
            c10 = cD06d1 * this%onebydx
            do k=1,n3
                do j=1,n2
   ...
   pure subroutine ComputeXD2RHS(this, f, RHS, n2, n3, bc1, bcn)
        ...
        select case (this%periodic)
        case (.TRUE.)
            a10 = aD06d2 * this%onebydx2
            b10 = bD06d2 * this%onebydx2
            c10 = cD06d2 * this%onebydx2
        ...
        case (.FALSE.)
            ...
            a_np_3 = b3_aD06d2 * this%onebydx2 
            b_np_3 = b3_bD06d2 * this%onebydx2 
       
            a_np_2 = b2_aD06d2 * this%onebydx2

            a_np_1 = b1_aD06d2 * this%onebydx2
            b_np_1 = b1_bD06d2 * this%onebydx2
            c_np_1 = b1_cD06d2 * this%onebydx2
            d_np_1 = b1_dD06d2 * this%onebydx2
            e_np_1 = b1_eD06d2 * this%onebydx2
