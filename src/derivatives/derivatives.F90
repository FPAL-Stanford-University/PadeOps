...
contains
    ...
    subroutine d2dx2(this,f,d2fdx2,bc1,bcn)
        ...
        case (2)
            call this%xcd06 % d2d1(f,d2fdx2,this%xsz(2),this%xsz(3))
        case (3)
    ...
    subroutine d2dy2(this,f,d2fdx2,bc1,bcn)
        ...
        case (2)
            call this%ycd06 % d2d2(f,d2fdx2,this%ysz(1),this%ysz(3))
        case (3)
    ...
    subroutine d2dz2(this,f,d2fdx2,bc1,bcn)
        ...
        case (1)
         ...
         case (2)
            call this%zcd06 % d2d3(f,d2fdx2,this%zsz(1),this%zsz(2))
        case (3)
