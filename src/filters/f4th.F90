...
module f4stuff
    ...
    private
    public :: f4, alpha90, beta90, a90, b90, c90, d90, e90
    
    ! 8th order filter coefficients with 90% truncation (See Lele (1992) for explanation)
    real(rkind), parameter :: alpha90= 0_rkind !real(6.6624D-1, rkind)
    real(rkind), parameter :: beta90 = 0_rkind !real(1.6688D-1, rkind)
    real(rkind), parameter :: a90    = 5_rkind / 8_rkind !real(9.9965D-1, rkind)
    real(rkind), parameter :: b90    = 1_rkind / 2_rkind / 2_rkind !real(6.6652D-1, rkind) ! Already divided by factor of 2 
    real(rkind), parameter :: c90    = -1_rkind/8_rkind/2_rkind !real(1.6674D-1, rkind) ! Already divided by factor of 2 
    real(rkind), parameter :: d90    = 0_rkind !real( 4.0D-5  , rkind) ! Already divided by factor of 2 
    real(rkind), parameter :: e90    = 0_rkind !real(-5.0D-6  , rkind) ! Already divided by factor of 2 
