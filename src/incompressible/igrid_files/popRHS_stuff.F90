   ...
   subroutine populate_RHS_extraTerms(this, copyFringeRHS, storeForBudget)
       ...
       elseif (this%localizedForceLayer == 2) then
           ...
           call this%spectForceLayer%updateRHS(this%uhat,this%vhat,this%what,&
             this%u,this%v,this%wC,this%TEhat,this%T,this%duidxjC, this%nu_SGS, this%tsim, &
      ...
      if (this%addExtraSourceTerm) then
        ...
        call hook_source(this%tsim,this%mesh,this%Re,this%what,this%u_rhs,this%v_rhs,&
          this%w_rhs,this%duidxjChat,this%duidxjEhat)
