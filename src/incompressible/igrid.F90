...
#include "igrid_files/RK4_staging.F90"
    ...
    subroutine init(this,inputfile, initialize2decomp)
       ...
       ! Print to terminal all the inputs
       ! INPUT
       call message(0,'namelist INPUT inputs:')
       call message(1,'nx',nx)
       call message(1,'ny',ny)
       call message(1,'nz',nz)
       call message(1,'tstop',tstop)
       call message(1,'dt',dt)
       call message(1,'CFL',CFL)
       call message(1,'nsteps',nsteps)
       call message(1,'inputdir: '//trim(inputdir))
       call message(1,'outputdir: '//trim(outputdir))
       call message(1,'prow',prow)
       call message(1,'pcol',pcol)
       call message(1,'useRestartFile',useRestartFile)
       call message(1,'restartFromViz',restartFromViz)
       call message(1,'restartFile_TID',restartFile_TID)
       call message(1,'restartFile_RID',restartFile_RID)
       call message(1,'CviscDT',CviscDT)
       call message(1,'nstepConstDt',nstepConstDt)
       call message(1,'restartFromDifferentGrid',restartFromDifferentGrid)
       call message(1,'nxS',nxS)
       call message(1,'nyS',nyS)
       call message(1,'nzS',nzS)
       ! IO
       call message(0,'namelist IO inputs:')
       call message(1,'vizDump_Schedule',vizDump_Schedule)
       call message(1,'deltaT_dump',deltaT_dump)
       call message(1,'t_restartDump',t_restartDump)
       call message(1,'t_dataDump',t_dataDump)
       call message(1,'ioType',ioType)
       call message(1,'dumpPlanes',dumpPlanes)
       call message(1,'runID',runID)
       ...
       call message(1,'t_start_pointProbe',t_start_pointProbe)
       call message(1,'t_stop_pointProbe',t_stop_pointProbe)
       call message(1,'t_pointProbe',t_pointProbe)
       ! PHYSICS
       call message(0,'namelist PHYSICS inputs:')
       call message(1,'isInviscid',isInviscid)
       call message(1,'useCoriolis',useCoriolis)
       call message(1,'useExtraForcing',useExtraForcing)
       call message(1,'isStratified',isStratified)
       call message(1,'useMoisture',useMoisture)
       call message(1,'Re',Re)
       call message(1,'Ro',Ro)
       call message(1,'Pr',Pr)
       call message(1,'Fr',Fr)
       call message(1,'Ra',Ra)
       call message(1,'useSGS',useSGS)
       call message(1,'use_SGS_scalar_mask',use_SGS_scalar_mask)
       call message(1,'PrandtlFluid',PrandtlFluid)
       call message(1,'BulkRichardson',BulkRichardson)
       call message(1,'BuoyancyTermType',BuoyancyTermType)
       call message(1,'useforcedStratification',useforcedStratification)
       call message(1,'useGeostrophicForcing',useGeostrophicForcing)
       call message(1,'G_geostrophic',G_geostrophic)
       call message(1,'G_alpha',G_alpha)
       call message(1,'dpFdx',dpFdx)
       call message(1,'dpFdy',dpFdy)
       call message(1,'dpFdz',dpFdz)
       call message(1,'assume_fplane',assume_fplane)
       call message(1,'latitude',latitude)
       call message(1,'useHITForcing',useHITForcing)
       call message(1,'useScalars',useScalars)
       call message(1,'frameAngle',frameAngle)
       call message(1,'buoyancyDirection',buoyancyDirection)
       call message(1,'useHITRealSpaceLinearForcing',useHITRealSpaceLinearForcing)
       call message(1,'HITForceTimeScale',HITForceTimeScale)
       call message(1,'addExtraSourceTerm',addExtraSourceTerm)
       call message(1,'useImmersedBodies',useImmersedBodies)
       call message(1,'numberOfImmersedBodies',numberOfImmersedBodies)
       call message(1,'immersed_taufact',immersed_taufact)
       call message(1,'localizedForceLayer',localizedForceLayer)
       ! BCs
       call message(0,'namelist BCs inputs:')
       call message(1,'PeriodicInZ',PeriodicInZ)
       call message(1,'topWall',topWall)
       ...
       call message(1,'useFringe',useFringe)
       call message(1,'usedoublefringex',usedoublefringex)
       call message(1,'useControl',useControl)
       ! WINDTURBINES
       call message(0,'namelist WINDTURBINES inputs:')
       call message(1,'useWindTurbines',useWindTurbines)
       call message(1,'num_turbines',num_turbines)
       call message(1,'ADM',ADM)
       call message(1,'turbInfoDir: '//trim(turbInfoDir))
       call message(1,'ADM_Type',ADM_Type)
       call message(1,'powerDumpDir: '//trim(powerDumpDir))
       call message(1,'useDynamicYaw',useDynamicYaw)
       call message(1,'yawUpdateInterval',yawUpdateInterval)
       call message(1,'inputDirDyaw = '//trim(inputDirDyaw))
       ! NUMERICS
       select case (AdvectionTerm)
           case (0)
               call message(1,'AdvectionTerm = Rotational form')
           case (1)
               call message(1,'AdvectionTerm = Skey-symmetric form')
       end select
       call message(1,'ComputeStokesPressure',ComputeStokesPressure)
       select case (NumericalSchemeVert)
           case (0)
               call message(1,'NumericalSchemeVert = Second order FD')
           case (1)
               call message(1,'NumericalSchemeVert = Sixth order compact difference')
           case (2)
               call message(1,'NumericalSchemeVert = Fourier collocation')
       end select
       call message(1,'UseDealiasFilterVert',UseDealiasFilterVert)
       call message(1,'t_DivergenceCheck',t_DivergenceCheck)
       select case (TimeSteppingScheme)
           case (0)
               call message(1,"TimeSteppingScheme = Adams-Bashfort")
           case (1)
               call message(1,"TimeSteppingScheme = TVD-RK3")
           case (2)
               call message(1,"TimeSteppingScheme = SSP-RK45")
           case (3)
               call message(1,"TimeSteppingScheme = SSP-RK45 (debug)")
           case (4)
               call message(1,"TimeSteppingScheme = Forward Euler")
           case (5)
               call message(1,"TimeSteppingScheme = RK4")
           case (6)
               call message(1,"TimeSteppingScheme = RK4 (debug)")
       end select
       call message(1,'InitSpinUp',InitSpinUp)
       call message(1,'useExhaustiveFFT',useExhaustiveFFT)
       call message(1,'dealiasFact',dealiasFact)
       call message(1,'scheme_xy = '//scheme_xy)
       call message(1,'donot_dealias',donot_dealias)
       call message(1,'dealiasType',dealiasType)
       call message(1,'clearRoundOffFreq',clearRoundOffFreq)
       ! KSPREPROCESS
       call message(0,'namelist KSPREPROCESS inputs:')
       call message(1,'PreprocessForKS',PreprocessForKS)
       call message(1,'KSoutputDir = '//trim(KSoutputDir))
       call message(1,'KSRunID',KSRunID)
       call message(1,'t_dumpKSprep',t_dumpKSprep)
       call message(1,'KSinitType',KSinitType)
       call message(1,'KSFilFact',KSFilFact)
       call message(1,'KSdoZfilter',KSdoZfilter)
       call message(1,'nKSvertFilt',nKSvertFilt)
       ! PRESSURE_CALC
       call message(0,'namelist PRESSURE_CALC inputs:')
       call message(1,'fastCalcPressure',fastCalcPressure)
       call message(1,'storePressure',storePressure)
       call message(1,'P_dumpFreq',P_dumpFreq)
       call message(1,'P_compFreq',P_compFreq)
       call message(1,'computeDNSPressure',computeDNSPressure)
       call message(1,'computeTurbinePressure',computeTurbinePressure)
       call message(1,'computeFringePressure',computeFringePressure)
       call message(1,'ComputeRapidSlowPressure',ComputeRapidSlowPressure)
       ! OS_INTERACTIONS
       call message(0,'namelist OS_INTERACTIONS inputs:')
       call message(1,'useSystemInteractions',useSystemInteractions)
       call message(1,'tSystemInteractions',tSystemInteractions)
       call message(1,'controlDir = '//trim(controlDir))
       call message(1,'deleteInstructions',deleteInstructions)
       ! SCALARS
       call message(0,'namelist SCALARS inputs:')
       call message(1,'num_scalars',num_scalars)
       call message(1,'scalar_info_dir = '//trim(scalar_info_dir))
       ! TURB_PRESSURE
       call message(0,'namelist TURB_PRESSURE inputs:')
       call message(1,'MeanTIDX',MeanTIDX)
       call message(1,'MeanRID',MeanRID)
       call message(1,'MeanFilesDir = '//trim(MeanFilesDir))
       ! MOISTURE
       call message(0,'namelist MOISTURE inputs:')
       call message(1,'moistureFactor',moistureFactor)
       call message(1,'moisture_info_dir = '//trim(moisture_info_dir))
