module sgsmod_igrid
    ...
    type :: sgs_igrid
        ...
        logical :: is_z0_varying = .false., filter_for_heterog = .true., LSM = .false., is_z0_stochastic = .false.
        ...
        contains 
            ...
            procedure,private  :: solve_nonlinprob_1
            procedure, private :: solve_nonlinprob_2
            procedure, private  :: feval_one            
            procedure , private :: feval_two
     end type 
