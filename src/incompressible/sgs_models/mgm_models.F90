    subroutine get_MGM_Op(this, tauC, tauE, duidxjC, duidxjE)
        class(sgs), intent(inout), target :: this
        real(rkind), dimension(this%gpC%xsz(1),this%gpC%xsz(2),this%gpC%xsz(3),6), target, intent(in) :: tauC
        real(rkind), dimension(this%gpC%xsz(1),this%gpC%xsz(2),this%gpC%xsz(3),2), target, intent(in) :: tauE
        real(rkind), dimension(this%gpC%xsz(1),this%gpC%xsz(2),this%gpC%xsz(3),9), target, intent(in) :: duidxjC
        real(rkind), dimension(this%gpC%xsz(1),this%gpC%xsz(2),this%gpC%xsz(3),9), target, intent(out) :: duidxjE
