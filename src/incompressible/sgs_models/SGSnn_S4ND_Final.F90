...
subroutine compute_tauij_NN(this,tidNow)
  ...
  !print *, finalout(1, 5, 3, 3)
  !print *, finalout(2, 15, 13, 13)
  !print *, finalout(3, 25, 53, 23)
  !print *, finalout(4, 45, 3, 3)
  !print *, finalout(6, 105, 93, 23)
  !print *, finaloutE(1, 5, 3, 3)
  !print *, finaloutE(2, 15, 13, 13)
  !print *, finaloutE(3, 25, 53, 23)
  !print *, finaloutE(4, 45, 3, 3)
  !print *, finaloutE(6, 105, 93, 23)
