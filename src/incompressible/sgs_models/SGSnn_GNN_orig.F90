subroutine init_SGSnn(this,NNtype)
   ...
   select case (NNtype)
   case (1) ! Unet
     allocate(this%invariants(1,this%gpC%xsz(1),this%gpC%xsz(3),this%gpC%xsz(2),11))
     allocate(this%invariantsnorm(1,this%gpC%xsz(1),this%gpC%xsz(3),this%gpC%xsz(2),11))
     ...
     allocate(this%invariantsE(1,this%gpE%xsz(1),this%gpE%xsz(3),this%gpE%xsz(2),11))
     allocate(this%invariantsEnorm(1,this%gpE%xsz(1),this%gpE%xsz(3),this%gpE%xsz(2),11))
...
subroutine compute_tauij_NN(this,tidNow)
  ...
  do k = 1, this%gpC%xsz(3)
    ...
    !print *, magoutE(1,32,32,32)
        ...
        if (this%NNtype == 1) then
          this%invariants(1, i, k, j, 1) = this%duidxj_C(i, j, k, 1)
          this%invariants(1, i, k, j, 2) = this%duidxj_C(i, j, k, 2)
          this%invariants(1, i, k, j, 3) = this%duidxj_C(i, j, k, 3)
          this%invariants(1, i, k, j, 4) = this%duidxj_C(i, j, k, 4)
          this%invariants(1, i, k, j, 5) = this%duidxj_C(i, j, k, 5)
          this%invariants(1, i, k, j, 6) = this%duidxj_C(i, j, k, 6)
          this%invariants(1, i, k, j, 7) = this%duidxj_C(i, j, k, 7)
          this%invariants(1, i, k, j, 8) = this%duidxj_C(i, j, k, 8)
          this%invariants(1, i, k, j, 9) = this%duidxj_C(i, j, k, 9)
          this%invariants(1, i, k, j, 10) = norm2(S_ij_a(:))
          this%invariants(1, i, k, j, 11) = norm2(R_ij_a(:))
          ...
          magout(1, i, j, k) = norm2(tgrad(i, j, k, :))
  ...
  if (this%NNtype == 1) then
    ...
    this%invariantsnorm(1,:,:,:,1) = (this%invariants(1,:,:,:,1)-MINVAL(this%invariants(1,:,:,:,1)))&
        /(MAXVAL(this%invariants(1,:,:,:,1))-MINVAL(this%invariants(1,:,:,:,1)))*2.0-1.0
    ...
    this%invariantsnorm(1,:,:,:,8) = (this%invariants(1,:,:,:,8)-MINVAL(this%invariants(1,:,:,:,8)))&
        /(MAXVAL(this%invariants(1,:,:,:,8))-MINVAL(this%invariants(1,:,:,:,8)))*2.0-1.0
    this%invariantsnorm(1,:,:,:,9) = (this%invariants(1,:,:,:,9)-MINVAL(this%invariants(1,:,:,:,9)))&
        /(MAXVAL(this%invariants(1,:,:,:,9))-MINVAL(this%invariants(1,:,:,:,9)))*2.0-1.0
    this%invariantsnorm(1,:,:,:,10) = (this%invariants(1,:,:,:,10)-MINVAL(this%invariants(1,:,:,:,10)))&
        /(MAXVAL(this%invariants(1,:,:,:,10))-MINVAL(this%invariants(1,:,:,:,10)))*2.0-1.0
    this%invariantsnorm(1,:,:,:,11) = (this%invariants(1,:,:,:,11)-MINVAL(this%invariants(1,:,:,:,11)))&
        /(MAXVAL(this%invariants(1,:,:,:,11))-MINVAL(this%invariants(1,:,:,:,11)))*2.0-1.0 
  end if
  ...
  do k = 1, this%gpC%xsz(3)
     do j = 1, this%gpC%xsz(2)
       do i = 1, this%gpC%xsz(1)
          ...
          this%rot(1, i, k, j, :, :) =  this%rot(1, i, k, j, :, :)/NORM2(this%rot(1, i, k, j, :, :))!*&
              !NORM2(this%rot(1, i, k, j, :, :))
  ...
  do k = 1, this%gpE%xsz(3)
     do j = 1, this%gpE%xsz(2)
       do i = 1, this%gpE%xsz(1)
         ...
         !arr_temp6 = matmul(matmul(arr_temp5,reshape(S_ij_a(:),[3,3],order=[2,1])),reshape(R_ij_a(:),[3,3],order=[2,1]))
         if (this%NNtype == 1) then
           this%invariantsE(1, i, k, j, 1) = this%duidxj_E(i, j, k, 1)
           this%invariantsE(1, i, k, j, 2) = this%duidxj_E(i, j, k, 2)
           this%invariantsE(1, i, k, j, 3) = this%duidxj_E(i, j, k, 3)
           this%invariantsE(1, i, k, j, 4) = this%duidxj_E(i, j, k, 4)
           this%invariantsE(1, i, k, j, 5) = this%duidxj_E(i, j, k, 5)
           this%invariantsE(1, i, k, j, 6) = this%duidxj_E(i, j, k, 6)
           this%invariantsE(1, i, k, j, 7) = this%duidxj_E(i, j, k, 7)
           this%invariantsE(1, i, k, j, 8) = this%duidxj_E(i, j, k, 8)
           this%invariantsE(1, i, k, j, 9) = this%duidxj_E(i, j, k, 9)
           this%invariantsE(1, i, k, j, 10) = norm2(S_ij_a(:))
           this%invariantsE(1, i, k, j, 11) = norm2(R_ij_a(:))
           ...
           magoutE(1, i, j, k) = norm2(tgradE(i, j, k, :))
  ...
  if (this%NNtype == 1) then
    ...
    this%invariantsEnorm(1,:,:,:,1) = (this%invariantsE(1,:,:,:,1)-MINVAL(this%invariantsE(1,:,:,:,1)))&
        /(MAXVAL(this%invariantsE(1,:,:,:,1))-MINVAL(this%invariantsE(1,:,:,:,1)))*2.0-1.0
    ...
    this%invariantsEnorm(1,:,:,:,8) = (this%invariantsE(1,:,:,:,8)-MINVAL(this%invariantsE(1,:,:,:,8)))&
        /(MAXVAL(this%invariantsE(1,:,:,:,8))-MINVAL(this%invariantsE(1,:,:,:,8)))*2.0-1.0
    this%invariantsEnorm(1,:,:,:,9) = (this%invariantsE(1,:,:,:,9)-MINVAL(this%invariantsE(1,:,:,:,9)))&
        /(MAXVAL(this%invariantsE(1,:,:,:,9))-MINVAL(this%invariantsE(1,:,:,:,9)))*2.0-1.0
    this%invariantsEnorm(1,:,:,:,10) = (this%invariantsE(1,:,:,:,10)-MINVAL(this%invariantsE(1,:,:,:,10)))&
        /(MAXVAL(this%invariantsE(1,:,:,:,10))-MINVAL(this%invariantsE(1,:,:,:,10)))*2.0-1.0
    this%invariantsEnorm(1,:,:,:,11) = (this%invariantsE(1,:,:,:,11)-MINVAL(this%invariantsE(1,:,:,:,11)))&
        /(MAXVAL(this%invariantsE(1,:,:,:,11))-MINVAL(this%invariantsE(1,:,:,:,11)))*2.0-1.0
  ...
  do k = 1, this%gpE%xsz(3)
    do j = 1, this%gpE%xsz(2)
      do i = 1, this%gpE%xsz(1)
         ...
         this%rotE(1, i, k, j, :, :) =  this%rotE(1, i, k, j, :, :)/NORM2(this%rotE(1, i, k, j, :, :))!*&
             !NORM2(this%rotE(1, i, k, j, :, :))
 ...
 ! end do
  ...
  trace = finalout(1,1,:,:,:)*magout(1,:,:,:)+finalout(1,4,:,:,:)*magout(1,:,:,:)+finalout(1,6,:,:,:)*magout(1,:,:,:)
  this%tau_11 = finalout(1,1,:,:,:)*magout(1,:,:,:)-1.0/3.0*(trace)
  this%tau_12 = finalout(1,2,:,:,:)*magout(1,:,:,:)
  this%tau_13 = finaloutE(1,3,:,:,:)*magoutE(1,:,:,:)
  this%tau_22 = finalout(1,4,:,:,:)*magout(1,:,:,:)-1.0/3.0*(trace)
  this%tau_23 = finaloutE(1,5,:,:,:)*magoutE(1,:,:,:)
  this%tau_33 = finalout(1,6,:,:,:)*magout(1,:,:,:)-1.0/3.0*(trace)
