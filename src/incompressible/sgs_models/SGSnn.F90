...
subroutine compute_tauij_NN(this,tidNow)
  ...
  del = ((this%dx*this%dy*this%dz)**(1.0/3.0))**2.0
    ...
    do j = 1, this%gpC%xsz(2)
      do i = 1, this%gpC%xsz(1)
        ...
        if (this%NNtype == 1) then
          ...
          this%invariantsnorm(1, i, k, j, 2) = this%invariants(1, i, k, j, 2)/magout(1, i, j, k)
          this%invariantsnorm(1, i, k, j, 3) = this%invariants(1, i, k, j, 3)/magout(1, i, j, k)
     ...
     do j = 1, this%gpE%xsz(2)
       do i = 1, this%gpE%xsz(1)
         ...
         if (this%NNtype == 1) then
           ...
           this%invariantsEnorm(1, i, k, j, 2) = this%invariantsE(1, i, k, j, 2)/magoutE(1, i, j, k)
           this%invariantsEnorm(1, i, k, j, 3) = this%invariantsE(1, i, k, j, 3)/magoutE(1, i, j, k)
