module SolidMod
    ...
    type :: solid
        ...
        real(rkind), dimension(:,:,:,:), allocatable :: devstress,gradYs,gradVF
        ...
        real(rkind), dimension(:,:,:),   allocatable :: QtmpYs,QtmpspecYs,QtmpRhom
    ...
    contains
        ...
        procedure :: update_g
        procedure :: update_rhom
        procedure :: getRHS_rhom
...
contains
    ...
    subroutine init(this,decomp,der,derD02,derD04,derD06,derStagg,derStaggd02,interpMid,interpMid02,use_Stagg,LADN2F, LADInt,LADMass_Consv,fil,gfil,PTeqb,pEqb,pRelax,use_gTg,useOneG,intSharp,intSharp_spf,intSharp_ufv,intSharp_d02,intSharp_cut,intSharp_cpg_west,useAkshayForm,twoPhaseLAD,LAD5eqn, updateEtot,strainHard,cnsrv_g,cnsrv_gt,cnsrv_gp,cnsrv_pe,ns, x_bc, y_bc, z_bc,SpongeLayer, skew_mass, skew_Ys, skew_VF)
        ...
        if( allocated( this%gradYs ) ) deallocate( this%gradYs )
        allocate( this%gradYs(this%nxp,this%nyp,this%nzp,3) )
        ...
        allocate( this%QtmpYs(this%nxp,this%nyp,this%nzp) )
         ...
         ! Ys equation
        if( allocated( this%QtmpRhom) ) deallocate( this%QtmpRhom )
        allocate( this%QtmpRhom(this%nxp,this%nyp,this%nzp) )
    ...
    subroutine getFaces(this,rho,periodicx,periodicy,periodicz,x_bc,y_bc,z_bc)
        use operators, only: interpolateFV,filter3D
    ...
    subroutine getYsLAD(this,rho,sos,dx,dy,dz,periodicx,periodicy,periodicz,x_bc,y_bc,z_bc)
       use operators, only: divergence,gradient,divergenceFV,interpolateFV,interpolateFV_x,interpolateFV_y,interpolateFV_z, gradFV_N2Fx, gradFV_N2Fy, gradFV_N2Fz,interpolateMax,filter3D
   ...
   subroutine update_rhom(this,isub,dt,rho,u,v,w,sos,x,y,z,tsim,periodicx,periodicy,periodicz,x_bc,y_bc,z_bc,sponge,alpha)
        use decomp_2d,  only: nrank
        ...
        call this%getRHS_rhom(rho,u,v,w,sos,rhsYs,dx,dy,dz,periodicx,periodicy,periodicz,x_bc,y_bc,z_bc,alpha) 

        if(isub==1) this%QtmpRhom = zero !this%rhom                   ! not really needed, since RK45_A(1) = 0
!        this%QtmpYs  = dt*rhsYs + RK45_A(isub)*this%QtmpYs
!        this%rhom = RK3_B(isub)*(this%rhom + dt*rhsYs)  + RK3_A(isub)*this%QtmpYs
         this%QtmpRhom  = dt*rhsYs + RK45_A(isub)*this%QtmpRhom
         this%rhom = this%rhom  + RK45_B(isub)*this%QtmpRhom        
    ...
    subroutine update_Ys(this,isub,dt,rho,u,v,w,umid,vmid,wmid,sos,x,y,z,tsim,periodicx,periodicy,periodicz,x_bc,y_bc,z_bc,sponge,alpha)
        ...
        ! advance sub-step
        if(isub==1) this%QtmpYs = zero ! this%consrv(:,:,:,1)                   ! not really needed, since RK45_A(1) = 0
!        this%QtmpYs  = dt*rhsYs + RK45_A(isub)*this%QtmpYs
         this%QtmpYs  = dt*rhsYs + RK45_A(isub)*this%QtmpYs
...
!          call divergenceFV(this%decomp,this%derStagg,-u*0.0,-v*this%rhoYs_mid(:,:,:,1),-w*this%rhoYs_mid(:,:,:,3),tmp,periodicx,periodicy,periodicz,x_bc,y_bc,z_bc)
    ...
    subroutine update_VF(this,other,isub,dt,rho,u,v,w,umid,vmid,wmid,sos,x,y,z,tsim,divu,src,periodicx,periodicy,periodicz,x_bc,y_bc,z_bc, sponge,alpha)
        ...
        ! advance sub-step
        if(isub==1) this%QtmpVF = zero ! this%VF                   ! not really needed, since RK45_A(1) = 0
  ...
  !        call divergence(this%decomp,this%der,-u*this%VF,-v*0.0,-w*this%VF,tmp4,x_bc,y_bc,z_bc)
    ...
    subroutine LAD_Quant(this,rho,periodicx,periodicy,periodicz,x_bc,y_bc,z_bc)
        ...
        real(rkind) :: md1 = (1d-6)**(0.5)
          ...
          call gradFV_N2Fx(this%decomp,this%derStagg,rho*this%Ys,this%gradYs(:,:,:,1),periodicx,periodicy,periodicz,x_bc,y_bc,z_bc)
...
!          call divergenceFV(this%decomp,this%derStagg,adiff_fil1*this%gradVF(:,:,:,1),adiff_fil2*this%gradVF(:,:,:,2),adiff_fil3*this%gradVF(:,:,:,3),this%vfLAD,periodicx,periodicy,periodicz,x_bc,y_bc,z_bc)
!          call divergenceFV(this%decomp,this%derStagg,adiff_fil1*this%gradYs(:,:,:,1),adiff_fil2*this%gradYs(:,:,:,2),adiff_fil3*this%gradYs(:,:,:,3),this%YsLAD,periodicx,periodicy,periodicz,x_bc,y_bc,z_bc)
    ...
    subroutine getLAD_VF(this,rho,sos,periodicx,periodicy,periodicz,x_bc,y_bc,z_bc,dx,dy)
        use operators, only: gradient,divergence, interpolateFV,interpolateFV_x, interpolateFV_y, interpolateFV_z, divergenceFV,gradFV_N2Fx,gradFV_N2Fy,gradFV_N2Fz,interpolateMax,filter3D
        use constants, only: one
        use reductions,       only: P_SUM, P_MEAN, P_MAXVAL, P_MINVAL
        class(solid), intent(inout)  :: this
...
!          call divergenceFV(this%decomp,this%derStagg,-tmpx,-tmpy,-0_rkind*tmpx,div_uVF,periodicx,periodicy,periodicz,x_bc,y_bc,z_bc) 
    ...
    subroutine getSpeciesDensity(this,rho,rhom)
        ...
        real(rkind) :: eps1 = 1d-12, eps2 = 0.70,threshold, minVF = 1d-6 , n = 1, e = 1d-8, epsil = 7.8125d-3
        real(rkind) :: intSharp_eps = 7.8125d-3, intSharp_cut = 0d-6
        real(rkind), dimension(this%nxp,this%nyp,this%nzp) :: psi,VFpsi
        ...
        psi =  intSharp_eps*log( ( abs(this%VF) + e )/ (abs(1 -  this%VF) + e) )
