module Sep1MultEOS
    ...
    type, extends(elasticeos) :: sep1mult
...
contains
    ...
    pure subroutine get_devstress(this,finger,fingersq,trG,trG2,detG,rho0_mix,mu_mix,devstress)
        ...
        do i = 1,6
            devstress(:,:,:,i) = -mu_mix*(detG**(-sixth)*fingersq(:,:,:,i) - detG**sixth*finger(:,:,:,i))
        end do
        devstmp = mu_mix*(detG**(-sixth)*trG2 - detG**sixth*trG)
    ...
    subroutine get_eelastic(this,trG,trG2,detG,rho0mix,mumix,eelastic)
        ...
        eelastic = fourth*mu_mix/rho0_mix*(detG**(-twothird)*trG2 - two*detG**(-third)*trG + three)
