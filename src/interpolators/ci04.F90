...
module ci04stuff
    ...
    real(rkind), parameter :: d06d1   = 0_rkind ! -0.010037510851538232297657617058214_rkind !0.0_rkind ! -0.011319774957278_rkind !-0.021133643295368085549323379715778_rkind !-0.010059833659454136208637051948312_rkind !0.0_rkind !0.0026067105764375561415478540778853_rkind    
    real(rkind), parameter :: e06d1   =   0.0_rkind    
...
contains
    ...
    subroutine ComputeXD1RHS(this,f,RHS, dir, n2, n3,bc1,bcn) 
        ...
        integer ::  j, k
        real(rkind) :: a06, b06,a10,a104,a102,b10,b102,b104,c10,c102,c104,a101,c06,d06,e06
           ...
           case("N2F")
            ...
            do k = 1,n3
                    RHS(1         ,:,k) = a06 * ( f(2,:,k)          + f(1       ,:,k) ) &
                                        ...
                                        + e06 * ( f(6,:,k)          + f(this%n-3,:,k) )

                    RHS(2         ,:,k) = a06 * ( f(3,:,k)          + f(2 ,:,k) ) &
                                        + b06 * ( f(4,:,k)          + f(1 ,:,k) ) &
                                        + c06 * ( f(5,:,k)          + f(this%n,:,k) ) &
                                        + d06 * ( f(6,:,k)          + f(this%n-1,:,k) ) &
                                        + e06 * ( f(7,:,k)          + f(this%n-2,:,k) )

                    RHS(3         ,:,k) = a06 * ( f(4,:,k)          + f(3 ,:,k)) &
                                         + b06 *( f(5,:,k)          + f(2 ,:,k) ) &
                                         + c06 *( f(6,:,k)          + f(1,:,k) )&
                                         + d06 *( f(7,:,k)          + f(this%n,:,k) ) &
                                         + e06 *( f(8,:,k)          + f(this%n-1,:,k) )

                    RHS(4         ,:,k) = a06 * ( f(5,:,k)          + f(4,:,k)) &
                                         + b06 *( f(6,:,k)          + f(3 ,:,k) ) &
                                         + c06 *( f(7,:,k)          + f(2,:,k) )  &
                                         + d06 *( f(8,:,k)          + f(1,:,k) )  &
                                         + e06 *( f(9,:,k)          + f(this%n,:,k) ) 
                                         

                    RHS(5:this%n-3,:,k) = a06 * ( f(6:this%n-4,:,k)     + f(5:this%n-3,:,k) ) &
                                        + b06 * ( f(7:this%n-3 ,:,k)    + f(4:this%n-4,:,k) ) &
                                        + c06 * ( f(8:this%n-2, :, k )  + f(3:this%n-5,:,k) ) &
                                        + d06 * ( f(9:this%n-1,:,k )    + f(2:this%n-6,:,k) ) &
                                        + e06 * ( f(10:this%n,:,k )      + f(1:this%n-7,:,k) ) 

                    RHS(this%n-4,:,k) =   a06 * ( f(this%n-3,:,k)       + f(this%n-4,:,k) ) &
                                        + b06 * ( f(this%n-2  ,:,k)     + f(this%n-5,:,k) ) &
                                        + c06 * ( f(this%n-1, :, k )    + f(this%n-6,:,k) ) &
                                        + d06 * ( f(this%n,:,k )        + f(this%n-7,:,k) ) &
                                        + e06 * ( f(1,:,k)              + f(this%n-8,:,k) )
