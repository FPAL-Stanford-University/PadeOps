...
module ci04modstuff
    ...
    private
    public :: ci04mod, alpha06d1, a06d1, b06d1
    
    ! 6th order first derivative coefficients (See Lele (1992) for explanation)
    real(rkind), parameter :: alpha06d1= 0.46_rkind !0.2_rkind !0.3_rkind !0.445_rkind !0.43_rkind !1.0_rkind / 3.0_rkind
    real(rkind), parameter :: c06d1    = -0.033110417755379564464723973327471_rkind !0.062225586445695505940662100207807_rkind !0.026774947022703344529553413297784_rkind !-0.019293325241934_rkind !-0.015334241226021_rkind ! (-12._rkind + 8.0_rkind*alpha06d1)/128_rkind 
    real(rkind), parameter :: a06d1    = 1.6543312532661386933941719199824_rkind !1.3937829564145505841347073018367_rkind !1.503250725748136008015921566854_rkind !1.642663349516132_rkind !1.631831517547958_rkind ! (1.0_rkind / 8.0_rkind) * (9._rkind + 10._rkind*alpha06d1 + 16.0*c06d1 ) 
    real(rkind), parameter :: b06d1    = 0.29466874673386130660582808001759_rkind !-0.034874899564878004526046022328753_rkind !0.080034160888614783663162071796518_rkind !0.266629975725803_rkind !0.243502723678064_rkind ! 1._rkind/8._rkind*(6._rkind*alpha06d1 - 1._rkind - 24._rkind*c06d1) !1.0_rkind / 10.0_rkind) / 2.0_rkind
    real(rkind), parameter :: d06d1   =  0.0041104177553795644647239733274709_rkind ! -0.011319774957278_rkind !-0.021133643295368085549323379715778_rkind !-0.010059833659454136208637051948312_rkind !0.0_rkind !0.0026067105764375561415478540778853_rkind    
    ...
    real(rkind), parameter                   :: p     =   5._rkind / 16._rkind
    real(rkind), parameter                   :: q     =  15._rkind / 16._rkind
    real(rkind), parameter                   :: r     =  -5._rkind / 16._rkind
    real(rkind), parameter                   :: s     =   1._rkind / 16._rkind 
    ...
    real(rkind), parameter                   :: w1 = 1
    real(rkind), parameter                   :: w2 = 1
    real(rkind), parameter                   :: w3 = 1
...
contains
    ...
    function init(this, n_, dx_, periodic_, bc1_, bcn_) result(ierr)
        ...
        class( ci04mod), intent(inout) :: this
    ...
    subroutine ComputeXD1RHS(this,f,RHS, dir, n2, n3,bc1,bcn) 
        ...
        case (.FALSE.)
            ...
            b_np_1 = 15._rkind / 16._rkind
            c_np_1 = -5._rkind / 16._rkind
